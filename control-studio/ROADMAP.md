...
**111/111 scripts pass** — run via `bash scripts/run_all_verify.sh` or `npm run verify:all` (was 82/82 before Functional Roadmap additions). Fixture/API contract coverage is now **8/8 cases**, including open-loop controller cascade response, non-step waveform metrics gating, and non-unit step amplitude reference metrics.
