...
- Functional Roadmap Tier A-G checkpoint：A1 ADRC、A2 ILC、A3 SMC + Super-twisting、A4 Backstepping、B1 SINDy、D1 active-set QP、E1/E2/E4/E5/E7 numerical core、F1 reachability、F4 falsification、G2 move blocking 已有 deterministic verification；最新 full suite 基線見 `control-studio/ROADMAP.md`。
