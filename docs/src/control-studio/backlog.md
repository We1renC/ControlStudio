...
- Functional Roadmap Tier A-G checkpoint：Tier A A1~A7 algorithm baseline 已完成；B1 SINDy、B2 closed-loop identification、B3 SRIVC continuous-time identification、B4 GP regression、B5 Hammerstein/Wiener identification、B6 MIMO FRF identification、C1 MHE、C2 particle filter、C3 dual EKF、C4 RTS smoother、D1 active-set QP、D2 ADMM QP、D3 SQP、D4 MILP、D5 L-BFGS/trust-region、D6 MIMPC、E1/E2/E4/E5/E7 numerical core、F1 reachability、F4 falsification、G2 move blocking 已有 deterministic verification；最新 full suite 基線見 `control-studio/ROADMAP.md`。
