...
| P25-03 SS minreal / Kalman decomposition | Done | direct `Ck`/`Ok` SVD, zero-state MIMO shape, and similarity transfer equivalence; `verify_p25_model_reduction.mjs` 45/45 |
