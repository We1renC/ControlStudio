...
| --- | --- | --- | --- | --- | --- | --- |
| CS-P0-01 | P0 | Next | Fixture-based verification runner | 五個數學推導案例目前已在文件中，需轉成可重跑 fixture，避免手動驗證流失 | `CONTROL_SYSTEM_VERIFICATION_CASES.md` | 新增 fixtures，`node test_control.js` 能逐案輸出 pass/fail |
...
1. `test(control): add verification fixture runner`
   - 新增 fixture JSON 或 JS case table。
   - 將 `CONTROL_SYSTEM_VERIFICATION_CASES.md` 的五個案例至少覆蓋 CLI/local core。
