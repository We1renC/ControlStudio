...
grep -q "Verification fixtures passed: 9/9" /tmp/nvidia-control-verification-cases.txt
grep -q "API contract fixtures passed: 9/9" /tmp/nvidia-control-api-contract.txt
grep -q "Verification fixtures passed: 9/9" /tmp/nvidia-control-npm-verify-math.txt
